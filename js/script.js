...
function validay() {
  ...
  else if( document.akanForm.day.value == "" || isNaN( document.akanForm.month.value ) ||
  document.akanForm.month.value.length != 2|| document.akanForm.day.value > 31 || document.akanForm.day.value <= 0) {
     alert( "Please provide a valid Day of Birth" );
